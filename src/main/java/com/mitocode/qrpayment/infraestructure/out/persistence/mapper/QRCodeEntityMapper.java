...
public class QRCodeEntityMapper {
	...
	public static QRCode toDomain(QRCodeEntity entity) {
		QRCode qr = new QRCode(entity.getType(), entity.getPurchaseOrder(), entity.getMerchantId(),
				entity.getExpirateDate(), entity.getCurrencyCode(), entity.getAmount());
